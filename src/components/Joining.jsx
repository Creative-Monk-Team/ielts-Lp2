...
let Joining = () => {
  ...
  return (
    <div className={styles.joiningParent} id="courses">
      ...
      >
        <h1 ref={aboutRef}>Frequently Asked Questions (FAQs)</h1>
        <p className={styles.faqDesc}>
          Clear Answers to Common Queries About IELTS Preparation, Test Format,
          Scoring, and How We Can Help You Succeed
        </p>
      </div>
